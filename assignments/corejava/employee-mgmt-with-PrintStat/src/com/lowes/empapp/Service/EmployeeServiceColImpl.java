...
public class EmployeeServiceColImpl implements com.lowes.empapp.Service.EmployeeService {
  ...
  /*  public List<Employee> importEmployeeArrayList(){
...
/*
    ...
    public Set<Employee> readEmployeeHashSet() {
        List<Employee> setList = new LinkedList(this.hashSet);
        Collections.sort(setList);
        this.hashSet = new HashSet(setList);
        return this.hashSet;
    }
    ...
    public Set<Employee> readEmployeeLinkedHashSet() {
        List<Employee> setList = new LinkedList(this.linkedHashSet);
        Collections.sort(setList);
        this.linkedHashSet = new HashSet(setList);
        return this.linkedHashSet;

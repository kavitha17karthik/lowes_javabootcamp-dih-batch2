...
Then('Activation Failure', () => {
  //ItemEntry.paymentStartStubsBFF('activate');
  ItemEntry.paymentStartStubsBFF();
  TenderPage.activateAPIStub();
  ItemEntry.payNowButton.click();
});
